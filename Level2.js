class Level2 extends Phaser.Scene {
    ...
    create() {
        ...
        this.levelMusic = this.sound.add('level2Music');
        ...
        this.map = this.make.tilemap({ key: "level2Map"});
        this.tileset = this.map.addTilesetImage("level2Tileset", "level2Tiles");
        buildMap(this);

        // Background
        this.background = this.add.image(0, 0, "level2Background");
        ...
        // Place landing pad
        this.landingPad = this.matter.add.sprite(1664, 2360, "landingPadBig").setStatic(true).setName("landingPad");
