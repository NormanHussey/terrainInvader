class Level1 extends Phaser.Scene {
    ...
    create() {
        ...
        this.levelMusic = this.sound.add('level1Music');
        ...
        this.tileset = this.map.addTilesetImage("MeadowDay", "tiles");
        buildMap(this);

        // Background
        this.background = this.add.image(0, 0, "level1Background");
        this.background.setOrigin(0, 0);
        this.background.setDepth(0);
        
        // World Bounds
        this.levelWidth = 2400;
        this.levelHeight = 1600;
        ...
        let startingX = 100;
        let startingY = 150;
        if (this.playerInfo.maxHealth != undefined) {
            ...
            createLander(this, startingX, startingY, 80, 0.035, 500, 200, 
                [{
                    type: 'smallBomb',
                    quantity: 0
                }],
        ...
        // Place landing pad
        this.landingPad = this.matter.add.sprite(2240, 1418, "landingPadBig").setStatic(true).setName("landingPad");
