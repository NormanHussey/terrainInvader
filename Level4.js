class Level4 extends Phaser.Scene {
    ...
    create() {
        ...
        this.levelMusic = this.sound.add('level4Music');
        ...
        this.map = this.make.tilemap({ key: "level4Map"});
        this.tileset = this.map.addTilesetImage("level4Tileset", "level4Tiles");
        buildMap(this);

        // Background
        this.background = this.add.image(0, 0, "level4Background");
        this.background.setOrigin(0, 0);
        this.background.setDepth(0);
        
        // World Bounds
        this.levelWidth = 2400;
        this.levelHeight = 3200;
        ...
        // Place landing pad
        this.landingPad = this.matter.add.sprite(1392, 3082, "landingPadMed").setStatic(true).setName("landingPad");
