class Level3 extends Phaser.Scene {
    ...
    create() {
        ...
        this.levelMusic = this.sound.add('level3Music');
        ...
        this.map = this.make.tilemap({ key: "level3Map"});
        this.tileset = this.map.addTilesetImage("level3Tileset", "level3Tiles");
        buildMap(this);

        // Background
        this.background = this.add.image(0, 0, "level3Background");
        this.background.setOrigin(0, 0);
        this.background.setDepth(0);
        
        // World Bounds
        this.levelWidth = 2400;
        this.levelHeight = 2800;
        ...
        this.lander.setFriction(0);

        // Place landing pad
        this.landingPad = this.matter.add.sprite(1136, 2764, "landingPadBig").setStatic(true).setName("landingPad");
