class Level5 extends Phaser.Scene {
    ...
    create() {
        ...
        this.levelMusic = this.sound.add('level5Music');
        ...
        this.map = this.make.tilemap({ key: "level5Map"});
        this.tileset = this.map.addTilesetImage("level5Tileset", "level5Tiles");
        buildMap(this);

        // Background
        this.background = this.add.image(0, 0, "level5Background");
        ...
        // Place landing pad
        this.landingPad = this.matter.add.sprite(824, 3192, "landingPadSmall").setStatic(true).setName("landingPad");
